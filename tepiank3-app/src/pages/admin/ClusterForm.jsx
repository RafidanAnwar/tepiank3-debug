                            ...
                            <form
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        maxLength={500}
                                        disabled={loading}
                                        className={`backdrop-blur-sm shadow-sm bg-white/90 w-full border rounded-lg px-3 py-2 text-gray-800 focus:outline-none hover:scale-[1.03] disabled:opacity-50 resize-none ${errors.description ? 'border-red-500' : 'border-blue-500'
                                            }`}
                                    />
                                    {errors.description && (
