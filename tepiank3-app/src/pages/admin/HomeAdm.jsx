                                            ...
                                            {currentpengajuan.map((p, i) => (
                                                <tr key={p.id} className="border-b border-gray-200 hover:bg-gray-50">
                                                    ...
                                                    <td className="px-4 py-2 text-center">
                                                        <span className={`px-3 py-1 rounded-full text-xs font-medium ${p.status === 'COMPLETED' ? 'bg-green-100 text-green-800' :
                                                            ...
                                                            {p.status === 'PENDING' ? 'Menunggu Persetujuan' :
                                                                p.status === 'CONFIRMED' ? 'Disetujui' :
                                                                    p.status === 'IN_PROGRESS' ? 'Dalam Pengerjaan' :
